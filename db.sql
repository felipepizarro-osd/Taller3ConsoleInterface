...
CREATE TABLE monstruos(
    id int not null not null primary key,
    nombre varchar(50) not null,
    velocidad int not null not null,
    salud int not null not null,
    id_user int not null not null,
    id_ataque int not null not null,
    id_especie int not null not null,
...
CREATE TABLE equipo (
    id_entrenador  int not null not null ,
    foreign key (id_entrenador) references entrenador(id),
    id_mounstruo1  int not null ,
    id_mounstruo2  int not null,
    id_mounstruo3  int not null,
    id_mounstruo4  int not null,
    id_mounstruo5  int not null,
    id_mounstruo6  int not null,
